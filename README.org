...
** Selectrum
   ...
   #+begin_src emacs-lisp
     ...
     ;; TODO: Incorporate embark to replace ivy command dispatching
     ...
     (use-package consult-projectile
       ...
       :straight (consult-projectile
                  ...
                  :branch "master")
       :config
       (bind-key "<SPC>" 'consult-projectile projectile-command-map)
...
** Kubernetes
   ...
   #+begin_src emacs-lisp
     (use-package kubernetes
       :straight (:local-repo "~/dev/kubernetes-el" :type git :host github :repo "jinnovation/kubernetes-el")
       :custom
