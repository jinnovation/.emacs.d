...
*** General
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (defvar jjin/font-priority-list
        '("IBM Plex Mono 14" "Source Code Pro 14" "Terminus (TTF) 16")
...
** Twitter
   ...
   #+begin_src emacs-lisp
     (use-package twitter-source
       :if (file-exists-p "~/workspace/twitter-source.el")
       :after transient
       :straight (:local-repo "~/workspace/twitter-source.el")
       :config
       (twitter-source-enable))
   #+end_src
   ...
   #+begin_src emacs-lisp
     (use-package doom-modeline
       ...
       (doom-modeline-def-modeline 'jjin
         ...
         '(misc-info persp-name jjin/datetime battery irc mu4e github debug lsp minor-modes input-method indent-info buffer-encoding process vcs checker))
