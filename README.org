...
*** General
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (defvar jjin/font-priority-list
        '("IBM Plex Mono 14" "Terminus (TTF) 16")
...
** ivy
   ...
   #+begin_src emacs-lisp
     ...
     (jjin/ivy-rich-package-stars 'elfeed)
   ...
   #+begin_src emacs-lisp
     (use-package doom-modeline
       ...
       (doom-modeline-def-modeline 'jjin
         ...
         '(objed-state misc-info persp-name datetime battery irc mu4e github debug lsp minor-modes input-method indent-info buffer-encoding major-mode process vcs checker))
