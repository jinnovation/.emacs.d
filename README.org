...
*** General
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      ;; TODO: Font size needs to scale w.r.t. `display-pixels-per-inch' or the
      ;; ID of the display it's currently displayed on.
...
*** Magit
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package forge
        ...
        :config
        (add-to-list 'forge-alist '("ghe.spotify.net" "ghe.spotify.net/api/v3" "spotify-ghe" forge-github-repository)))
   ...
   #+begin_src emacs-lisp
     (use-package shackle
       ...
       (shackle-rules '(
                        ...
                        ('(help-mode helpful-mode) :select t :other t :size 0.2)
                        (vterm-mode :align right :size 0.4 :select t)
                        (magit-log-mode :align left :size 0.3 :select t)
                        (magit-status-mode :align right :size 0.4 :select t)
                        (compilation-mode :align right :size 0.3)))
       :config
       (shackle-mode t))
   #+end_src
...
** Kubernetes
   ...
   #+begin_src emacs-lisp
     ...
     (use-package kubernetes
       ...
       :config
       (with-eval-after-load 'evil
         (add-to-list 'evil-visual-state-modes 'kubernetes-display-thing-mode)))
