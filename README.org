   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package pretty-hydra
       ...
       (pretty-hydra-define jjin-buffer-hydra
         (:title (with-material "code" "Buffers" 1 -0.005))
         ("Name"
...
** Treesitter
   ...
   #+begin_src emacs-lisp
     ...
     (use-package treesit
       ...
       :config
       (jjin/treesit-install-grammar-maybe 'go)
       (jjin/treesit-install-grammar-maybe 'python)
       (jjin/treesit-install-grammar-maybe 'typescript)
       (jjin/treesit-install-grammar-maybe 'tsx))
   #+end_src
