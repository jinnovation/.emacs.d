   ...
   #+begin_src emacs-lisp
     (use-package shackle
       ...
       (shackle-rules '(
                        ...
                        ('(help-mode helpful-mode) :select t :other t :size 0.4)
...
** Kubernetes
   ...
   #+begin_src emacs-lisp
     ...
     (use-package kubernetes
       ...
       :custom
       (kubernetes-overview-buffer-name "*k8s*" "More concise name than default *kubernetes-overview* (I know it's a damn overview)")
       :config
       (with-eval-after-load 'evil
