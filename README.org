...
** Twitter
   ...
   #+begin_src emacs-lisp
     (with-eval-after-load 'projectile
       (projectile-register-project-type 'twitter-source-sub nil
                                         :compilation-dir "~/workspace/source/"
                                         :compile "./pants "
                                         :test "./pants test "
                                         :run "./pants "))
     (use-package twitter-source
       :straight (:local-repo "~/proj/twitter-source.el")
       :config
       (with-eval-after-load 'helm-files
         (add-to-list 'helm-find-files-actions
                      '("Twitter Source Execute" . twitter-source-compile)
                      t)))
   #+end_src
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package elfeed-protocol
       ...
       :straight (:host github
                  ...
                  :fork (:host github :repo "jinnovation/elfeed-protocol" :branch "canary"))
...
*** Magit
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package magit
        ...
        (magit-define-popup-option 'magit-commit-popup ?M "Attach message" "--message=")
        ...
        (plist-put magit-merge-popup
                   :actions
                   (cons '(?U "Upstream" (lambda (&optional args)
                                           (interactive (magit-diff-arguments))
                                           (magit-merge "@{u}" args)))
