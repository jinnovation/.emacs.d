     ...
     (use-package mu4e
       ...
       (defvar my-mu4e-account-alist
         '(("personal"
           ...
           ("work"
            (user-mail-address "jonathan.jin@uber.com")
       ...
       (add-hook 'mu4e-compose-pre-hook
                 (defun my-set-from-address ()
                   ...
                   (let ((msg mu4e-compose-parent-message))
                     (when msg
                       (let ((addr-me (mu4e-message-contact-field-matches-me msg :to)))
                         (setq user-mail-address (cdr addr-me)))))))
